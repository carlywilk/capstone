...
Each email, phone number, and website link is clickable, allowing the user to navigate to whichever resource they choose with ease. 

Each healthcare resource card includes a list of services offered to help guide the user towards the resource(s) right for them.
